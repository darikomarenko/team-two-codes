...
export function renderPrices() {
    ...
    <h5 class="prices__title"> <img src="/images/Video-block/Line.png" alt="line" class="prices__line"> Our price table</h5>
        ...
        <div class="prices__cards">
            <div class="prices__cards_card">
                ...
                <div class="prices__cards_card-star"><img src="..//images/Prices/star.svg"/>Basic</div>
            ...
            <img src="..//images/Prices/special.svg" alt="Special Icon" /></div>
                <div class="prices__cards_card-price">$29.99 /M</div>
                <div class="prices__cards_card-star"><img src="..//images/Prices/star.svg"/>Standart</div>
                <div class="prices__cards_card-points">
                    <ul>
                        <li>24/7 Free Hotline Service</li>
                        <li>Chat Support</li>
            ...
            <div class="prices__cards_card">
                ...
                <div class="prices__cards_card-star"><img src="..//images/Prices/star.svg"/>Premium</div>
                <div class="prices__cards_card-points">
                    <ul>
                        <li>24/7 Free Hotline Service</li>
                        <li>Chat Support</li>
